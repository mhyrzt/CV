...
\begin{center}
    \textbf{\Huge \scshape Mahyar Riazati} \\ \vspace{3pt}
    \small
    \faMobile \hspace{.5pt} \href{tel:989128445978}{+98 912 844 5978}
    $|$
    \faAt \hspace{.5pt} \href{mailto:mr.riazati1999@gmail.com}{mr.riazati1999@gmail.com}
    $|$
    ...
    $|$
    \faGlobe \hspace{.5pt} \href{https://mhyrzt.github.io}{Portfolio}
    $|$
    \faMapMarker \hspace{.5pt} \href{https://maps.app.goo.gl/hUyctBKZmVKFwGY77}{Tehran, Iran}
\end{center}
...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{AI:}{ scikit-learn, numpy, pandas, PyTorch, OpenCV, Image Processing, Fuzzy Logic} \\ \vspace{3pt}
